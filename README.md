...
- `python3 bigclaw-go/scripts/e2e/run_task_smoke.py` and
  `python3 bigclaw-go/scripts/migration/shadow_compare.py` now forward into
  `bigclawctl automation ...`.
- Benchmark automation now lives directly under
  `go run ./bigclaw-go/cmd/bigclawctl automation benchmark <soak-local|run-matrix|capacity-certification>`.
- The migration matrix lives in
