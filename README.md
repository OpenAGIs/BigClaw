...
- The remaining legacy `scripts/ops/*workspace*.py` helpers are compatibility shims over the same
  Go CLI, but the GitHub sync and refill operator paths are now Go-only through
