...
- `bash scripts/ops/bigclawctl refill ...` is the canonical refill entrypoint.
- The legacy `scripts/ops/*workspace*.py` helpers remain compatibility shims over the same Go CLI.
