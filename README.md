...
- Root operator commands now run directly through `scripts/ops/bigclawctl`; the thin
  `bigclaw-issue`, `bigclaw-symphony`, and `bigclaw-panel` helper wrappers are retired.
