...
- `scripts/ops/bigclaw-issue`, `scripts/ops/bigclaw-symphony`, and `scripts/ops/bigclaw-panel` stay as
  thin compatibility pass-throughs. Treat `scripts/ops/bigclawctl` as the single supported root
  operator entrypoint.
