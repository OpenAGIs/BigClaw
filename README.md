...
- Benchmark automation is now called directly through `go run ./bigclaw-go/cmd/bigclawctl automation benchmark ...`
  for `soak-local`, `run-matrix`, and `capacity-certification`.
