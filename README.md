...
migration-only reference use. The legacy `python -m bigclaw` package entrypoint
has been retired along with the old package scaffolding; use
`scripts/ops/bigclawctl` for operator flows and `go run ./bigclaw-go/cmd/bigclawd`
