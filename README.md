...
- retired `src/bigclaw` Python foundations: the historical runtime, reporting, and operator-console surfaces have been materialized into `bigclaw-go/internal/*`, and regression tests now keep the deleted Python lane absent
