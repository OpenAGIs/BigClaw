...
The legacy Python execution-kernel modules have been retired from `src/bigclaw`.
Active runtime and service development belongs in `bigclaw-go/internal/*`; use
