...
- `bash scripts/ops/bigclaw_github_sync ...`,
  `bash scripts/ops/bigclaw_refill_queue ...`, and the legacy
  `scripts/ops/*workspace*` helpers are also compatibility wrappers over the same Go CLI.
