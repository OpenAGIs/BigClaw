...
- refill and workspace operator flows are Go-first only:
  `bash scripts/ops/bigclawctl refill ...`,
  `bash scripts/ops/bigclawctl workspace bootstrap ...`,
  and `bash scripts/ops/bigclawctl workspace validate ...`.
...
workspace bootstrap, workspace validate, and GitHub sync.
