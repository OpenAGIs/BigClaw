...
- The retired Python operator wrappers in `scripts/ops/*.py` have been removed; use
  `bash scripts/ops/bigclawctl refill ...`, `bash scripts/ops/bigclawctl workspace bootstrap ...`,
  and `bash scripts/ops/bigclawctl workspace validate ...` directly.
...
Python ops wrappers have been removed, and GitHub sync is Go/shell-only via
