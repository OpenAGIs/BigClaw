...
Title: `Residual tests Python sweep AJ`
...
- Repository sweep verification: `bigclaw-go/internal/regression/big_go_223_zero_python_guard_test.go`
...
- The live branch baseline was already Python-free, so BIG-GO-223 can only
