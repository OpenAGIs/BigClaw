...
Title: `Heartbeat refill lane 1349: remaining Python asset sweep 9/10`
...
- Repository sweep verification: `bigclaw-go/internal/regression/big_go_1349_zero_python_guard_test.go`
...
```text
ok  	bigclaw-go/internal/regression	0.543s
```
...
- The live branch baseline was already Python-free, so BIG-GO-1349 can only
