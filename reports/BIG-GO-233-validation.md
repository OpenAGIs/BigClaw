...
Title: `Residual tests Python sweep AL`
...
- Repository sweep verification: `bigclaw-go/internal/regression/big_go_233_zero_python_guard_test.go`
...
- The live branch baseline was already Python-free, so BIG-GO-233 can only
