...
Title: `Heartbeat refill lane 1229: remaining Python asset sweep 9/10`
...
- Repository sweep verification: `bigclaw-go/internal/regression/big_go_1229_zero_python_guard_test.go`
...
- The live branch baseline was already Python-free, so BIG-GO-1229 can only
