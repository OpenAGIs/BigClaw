...
Title: `Heartbeat refill lane 1454: remaining Python asset sweep 4/10`
...
- Repository sweep verification: `bigclaw-go/internal/regression/big_go_1454_zero_python_guard_test.go`
...
```text
ok  	bigclaw-go/internal/regression	0.778s
```
...
- The live branch baseline was already Python-free, so BIG-GO-1454 can only
