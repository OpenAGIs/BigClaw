...
Title: `Heartbeat refill lane 1438: remaining Python asset sweep 8/10`
...
- Repository sweep verification: `bigclaw-go/internal/regression/big_go_1438_zero_python_guard_test.go`
...
- The live branch baseline was already Python-free, so BIG-GO-1438 can only
