...
Title: `Residual src/bigclaw Python sweep N`
...
- Repository sweep verification: `bigclaw-go/internal/regression/big_go_171_zero_python_guard_test.go`
...
- Lane commit details: `git log --oneline --grep 'BIG-GO-171'`
...
- The live branch baseline was already Python-free, so BIG-GO-171 can only
