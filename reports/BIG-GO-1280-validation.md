...
```text
ok  	bigclaw-go/internal/regression	1.511s
```
...
- Code commit: `b2846a3c` (`BIG-GO-1280: add zero-python heartbeat artifacts`)
- Final metadata commit: `1062582d` (`BIG-GO-1280: finalize pushed metadata`)
