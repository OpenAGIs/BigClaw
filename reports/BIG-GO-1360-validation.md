...
Title: `Go-only refill 1360: remaining package/test helper purge`
...
- Repository sweep verification: `bigclaw-go/internal/regression/big_go_1360_zero_python_guard_test.go`
...
```text
ok  	bigclaw-go/internal/regression	0.893s
```

## Git

- Branch: `main`
- Baseline HEAD before lane commit: `78ffe050`
...
- The live branch baseline was already Python-free, so BIG-GO-1360 can only
