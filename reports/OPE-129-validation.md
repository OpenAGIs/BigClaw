...
- 测试环境: local-python3
- 生成时间: 2026-03-11T18:45:00+08:00
...
- `python3 -m pytest tests/test_dashboard_run_contract.py tests/test_execution_contract.py -q` -> `6 passed`
- `python3 -m pytest` -> `130 passed in 0.12s`
