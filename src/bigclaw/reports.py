...
from .runtime import ExecutionRecord, Scheduler
    ...
    return render_run_detail_console(
        ...
        tabs=[
            ...
            RunDetailTab(
                "artifacts",
                "Artifacts",
                render_resource_grid("Artifacts", "Generated reports and pages emitted for benchmark review and replay inspection.", execution_resources),
            ),
            RunDetailTab(
                "reports",
                "Reports",
