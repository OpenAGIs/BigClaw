"""Frozen Python compatibility surface for legacy design-system contracts.

Removal condition: delete this module once all remaining Python imports move to
`bigclaw-go/internal/product` and the Python design-system tests are retired.
"""
...
GO_MAINLINE_REPLACEMENT = "bigclaw-go/internal/product"
REMOVAL_CONDITION = (
    "Delete after the remaining Python UI/design-system imports and tests move to "
