...
_runtime_module = types.ModuleType(f"{__name__}.runtime")
_runtime_module.__package__ = __name__
sys.modules[_runtime_module.__name__] = _runtime_module
exec(
...
globals()["runtime"] = _runtime_module
_legacy_runtime_surface = _runtime_module
...
_ui_review_module = types.ModuleType(f"{__name__}.ui_review")
sys.modules[_ui_review_module.__name__] = _ui_review_module
exec(
r"""
from dataclasses import dataclass, field
from html import escape
...
""",
    _ui_review_module.__dict__,
)
_ui_review_module.GO_MAINLINE_REPLACEMENT = "bigclaw-go/internal/api/server.go"
globals()["ui_review"] = _ui_review_module
