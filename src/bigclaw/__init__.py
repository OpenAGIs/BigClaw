...
class Scheduler:
    ...
    def execute(
        ...
        from . import render_task_run_detail_page, render_task_run_report, write_report
...
_install_legacy_surface_module(
    ...
    LEGACY_MAINLINE_STATUS=(
        "bigclaw-go is the sole implementation mainline for active development; "
        "the package-root service compatibility surface remains migration-only."
    ),
    ...
    return CandidateBacklog(
        ...
        candidates=[
            ...
            CandidateEntry(
                ...
                evidence_links=[
                    EvidenceLink(
                        ...
                        note="folded package command center, dashboard builder, weekly review, and regression surfaces",
                    ),
                    EvidenceLink(
            ...
            CandidateEntry(
                ...
                validation_command=(
                    "cd bigclaw-go && go test ./internal/collaboration ./internal/pilot ./internal/reportstudio"
                ),
                ...
                evidence_links=[
                    ...
                    EvidenceLink(
                        ...
                        target="bigclaw-go/internal/reportstudio/reportstudio.go",
                        capability="commercialization",
                        note="Go-native orchestration canvas, portfolio rollups, and narrative exports",
                    ),
                    EvidenceLink(
