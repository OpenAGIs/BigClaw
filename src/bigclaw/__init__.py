...
from . import repo_plane as _legacy_repo_plane_surface
...
_install_legacy_surface_module(
    ...
    source_module=_legacy_repo_plane_surface,
...
_install_legacy_surface_module(
    "repo_links",
    ["RunCommitBinding", "bind_run_commits", "validate_roles"],
    source_module=_legacy_repo_plane_surface,
    VALID_ROLES=_legacy_repo_plane_surface.VALID_ROLES,
    GO_MAINLINE_REPLACEMENT="bigclaw-go/internal/repo/closeout_links.go",
)
_install_legacy_surface_module(
    "repo_registry",
    ["RepoRegistry"],
