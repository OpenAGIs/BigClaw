...
from typing import Any, Callable, DefaultDict, Deque, Dict, Iterable, List, Optional, Protocol, Sequence, Tuple
...
# Folded reports surface from legacy reports.py
...
# Folded observability surface from legacy observability.py
...
# Folded repository surface from legacy repository.py
...
# Folded models surface from legacy models.py
...
_legacy_runtime_surface = sys.modules[__name__]
_models_surface = _legacy_runtime_surface
_repository_surface = _legacy_runtime_surface
...
_REPOSITORY_EXPORT_NAMES = [
    ...
    "COMPONENT_READINESS_ORDER",
    "REQUIRED_INTERACTION_STATES",
    "VALID_VIEW_VISIBILITY",
    "VALID_DIGEST_CHANNELS",
    "VALID_DIGEST_CADENCES",
    "DesignToken",
    "ComponentVariant",
    "ComponentSpec",
    "DesignSystemAudit",
...
_install_surface_module("models", _models_surface, _MODELS_EXPORT_NAMES)
_install_surface_module(
    "connectors",
    _models_surface,
    ["Connector", "GitHubConnector", "JiraConnector", "LinearConnector", "SourceIssue", "map_priority", "map_state", "map_source_issue_to_task"],
)
_install_surface_module("mapping", _models_surface, ["map_priority", "map_state", "map_source_issue_to_task"])
_install_surface_module(
    "workspace_bootstrap",
    _models_surface,
    [
...
_install_surface_module("repository", sys.modules[f"{__name__}.runtime"], _REPOSITORY_EXPORT_NAMES)
_install_surface_module(
    "design_system",
...
_install_surface_module("observability", sys.modules[f"{__name__}.runtime"], _OBSERVABILITY_EXPORT_NAMES)
_install_surface_module(
    "collaboration",
...
_install_surface_module("risk", _models_surface, ["BudgetDecision", "CostController", "RiskFactor", "RiskScore", "RiskScorer"])
_install_surface_module("cost_control", _models_surface, ["BudgetDecision", "CostController"])
_install_surface_module("planning", _models_surface, _PLANNING_EXPORT_NAMES)
_install_surface_module(
    "dsl",
...
_install_surface_module("reports", sys.modules[f"{__name__}.runtime"], _REPORTS_EXPORT_NAMES)
_install_surface_module(
    "issue_archive",
...
_install_surface_module("runtime", sys.modules[__name__], __all__)
