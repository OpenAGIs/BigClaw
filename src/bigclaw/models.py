"""Frozen Python compatibility models kept only for residual Python callers.

Removal condition: delete this module once Python task/risk/workflow consumers
finish migrating to `bigclaw-go/internal/domain` and dependent Python tests are
retired.
"""
...
GO_MAINLINE_REPLACEMENT = "bigclaw-go/internal/domain"
REMOVAL_CONDITION = (
    "Delete after residual Python task/risk/workflow modules stop importing "
    "bigclaw.models in favor of bigclaw-go/internal/domain."
)
