...
class WorkflowEngine:
    ...
    def run(
        ...
        journal.record("execution", execution.run.status, medium=execution.decision.medium, approved=execution.decision.approved)
        ...
        resolved_journal_path = journal.write(journal_path) if journal_path else None
