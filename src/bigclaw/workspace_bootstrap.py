...
def workspace_bootstrap_main(
    ...
    *,
    ...
    try:
        ...
        emit_workspace_bootstrap_payload({"status": "error", "workspace": str(workspace), "error": str(exc)}, args.json)
        return 1
...
# Backward-compatible aliases for deleted thin wrapper modules.
build_parser = build_workspace_bootstrap_parser
emit = emit_workspace_bootstrap_payload
main = workspace_bootstrap_main
