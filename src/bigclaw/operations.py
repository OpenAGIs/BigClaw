...
from .runtime import PersistentTaskQueue
...
def render_run_replay_index_page(
    ...
    execution_resources = [
        RunDetailResource("Markdown report", "report", report_path, ["execution report"], "report"),
        RunDetailResource("Run detail page", "page", detail_path, ["task run detail"], "page"),
        RunDetailResource("Replay page", "page", replay_path, [f"matched={replay.matched}"], "page"),
    ]
