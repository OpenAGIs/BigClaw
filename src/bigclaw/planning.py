        ...
        candidates=[
            ...
            CandidateEntry(
                ...
                validation_command=(
                    ...
                    "'TestBuildSavedViewCatalog|TestAuditSavedViewCatalog|TestSavedViewCatalogJSONRoundTrip|TestRenderSavedViewReport'"
                ),
                ...
                evidence_links=[
                    ...
                    EvidenceLink(
                        ...
                        capability="saved-views",
                        note="Go-native saved-view catalog, audit, and report coverage",
                    ),
                    EvidenceLink(
