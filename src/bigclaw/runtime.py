...
Removal condition: delete this module once the remaining Python scheduler/runtime
tests are retired and callers move to `bigclaw-go/internal/worker/runtime.go`.
"""
