...
def build_bigclawctl_exec_args(repo_root: Path, command: Sequence[str], forwarded: Sequence[str]) -> List[str]:
...
def run_bigclawctl_shim(script_path: str, command: Sequence[str], forwarded: Sequence[str]) -> int:
