        ...
        return DashboardRunContract(
            ...
            dashboard_schema=SurfaceSchema(
                ...
                sample={
                    ...
                    "blockers": [
                        {
                            "title": "Approval backlog after policy update",
                            "severity": "high",
                    ...
                    "activity": [
                        {
                            ...
                            "task_id": "OPE-127",
                            "status": "completed",
                            "summary": "Release branch scan hardening shipped.",
                        }
                    ],
                },
            ),
            run_detail_schema=SurfaceSchema(
                name="RunDetail",
                owner="operations",
                description="Detailed run timeline, artifacts, and closeout evidence.",
                fields=[
