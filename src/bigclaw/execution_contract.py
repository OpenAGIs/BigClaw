    ...
    def build_default_contract(self) -> DashboardRunContract:
        return DashboardRunContract(
            ...
            dashboard_schema=SurfaceSchema(
                ...
                fields=[
                    ...
                    SchemaField(
                        ...
                        "string",
                        required=False,
                        description="Persona used for visibility rules.",
                    ),
                    SchemaField("summary.total_runs", "integer", description="Total runs in the period."),
                    SchemaField(
                        "summary.success_rate",
                        "number",
                        description="Completed-success ratio in percent.",
                    ),
                    SchemaField(
                        "summary.approval_queue_depth",
                        "integer",
                        description="Runs waiting for approval.",
                    ),
                    ...
                    SchemaField(
                        ...
                        "string",
                        required=False,
                        description="Healthy trend direction.",
                    ),
                    SchemaField(
                        "kpis[].healthy",
                        "boolean",
                        required=False,
                        description="Precomputed health state.",
                    ),
            ...
            run_detail_schema=SurfaceSchema(
                ...
                owner="runtime",
                description=(
                    "Canonical run detail payload for replay, timeline inspection, artifacts, "
                ...
                fields=[
                    ...
                    SchemaField(
                        "closeout.validation_evidence",
                        "string[]",
                        description="Validation proof captured before finish.",
                    ),
                    SchemaField(
                        "closeout.git_push_succeeded",
                        "boolean",
                        description="Whether push completed successfully.",
                    ),
                    SchemaField(
                        "closeout.git_push_output",
                        "string",
                        required=False,
                        description="Push command output.",
                    ),
                    SchemaField(
                        "closeout.git_log_stat_output",
                        "string",
                        description="Captured git log --stat output.",
                    ),
                ],
                sample={
                    "run_id": "run-204",
...
class ConsoleInteractionAudit:
    ...
    def from_dict(cls, data: Dict[str, object]) -> "ConsoleInteractionAudit":
        return cls(
            ...
            surfaces_missing_wireframe_links=[
                str(name) for name in data.get("surfaces_missing_wireframe_links", [])
            ],
