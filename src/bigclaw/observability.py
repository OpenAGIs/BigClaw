...
def build_collaboration_thread(
    ...
    *,
    ...
    return CollaborationThread(surface=surface, target_id=target_id, comments=list(comments or []), decisions=list(decisions or []))
...
def merge_collaboration_threads(
    *,
    ...
    return CollaborationThread(surface="merged", target_id=target_id, comments=merged_comments, decisions=merged_decisions)
