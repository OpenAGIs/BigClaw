...
1. Confirm the remaining physical Python asset inventory for the repository and
   ...
   `bigclaw-go/scripts`.
2. Add lane-scoped zero-Python sweep artifacts for `BIG-GO-1308`:
   - `bigclaw-go/docs/reports/big-go-1308-python-asset-sweep.md`
   - `bigclaw-go/internal/regression/big_go_1308_zero_python_guard_test.go`
   - `reports/BIG-GO-1308-status.json`
   - `reports/BIG-GO-1308-validation.md`
...
- `cd bigclaw-go && go test -count=1 ./internal/regression -run 'TestBIGGO1308(RepositoryHasNoPythonFiles|PriorityResidualDirectoriesStayPythonFree|ReplacementPathsRemainAvailable|LaneReportCapturesSweepState)$'`
