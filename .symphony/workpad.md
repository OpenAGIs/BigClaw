...
- Removed `src/bigclaw/reports.py` by keeping its legacy API available through package-level compat exports in `src/bigclaw/__init__.py`.
- `python3 -m pytest tests/test_reports.py tests/test_observability.py tests/test_control_center.py tests/test_operations.py tests/test_repo_rollout.py tests/test_audit_events.py` -> `71 passed in 0.12s`
