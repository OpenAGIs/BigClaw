...
- Remove the weekly report / bundle and engineering overview bundle Python tests whose render-write behaviors are already covered in `bigclaw-go/internal/reporting/reporting_test.go`.
...
## Acceptance
- Scope stays limited to the weekly reporting / engineering overview render-write slice removed from `tests/test_reports.py`.
