...
4. Tighten regression coverage so these active docs do not regress back to retired Python tooling guidance.
5. Run targeted regression and grep validation, then commit and push the follow-up branch state.
