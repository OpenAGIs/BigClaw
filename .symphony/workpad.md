...
- 2026-04-05: Re-ran `go test -count=1 ./internal/regression -run 'TestBIGGO1349(RepositoryHasNoPythonFiles|PriorityResidualDirectoriesStayPythonFree|ReplacementPathsRemainAvailable|LaneReportCapturesSweepState)$'` after rebasing onto `origin/main` and observed `ok  	bigclaw-go/internal/regression	3.212s`.
