...
2. Add lane-scoped zero-Python sweep artifacts for `BIG-GO-1301`:
   - `bigclaw-go/docs/reports/big-go-1301-python-asset-sweep.md`
   - `bigclaw-go/internal/regression/big_go_1301_zero_python_guard_test.go`
   - `reports/BIG-GO-1301-status.json`
   - `reports/BIG-GO-1301-validation.md`
...
- `cd bigclaw-go && go test -count=1 ./internal/regression -run 'TestBIGGO1301(RepositoryHasNoPythonFiles|PriorityResidualDirectoriesStayPythonFree|ReplacementPathsRemainAvailable|LaneReportCapturesSweepState)$'`
