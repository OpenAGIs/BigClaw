...
2. Materialize the lane-specific zero-Python evidence for `BIG-GO-1329`:
   - `bigclaw-go/docs/reports/big-go-1329-python-asset-sweep.md`
   - `reports/BIG-GO-1329-status.json`
   - `reports/BIG-GO-1329-validation.md`
   - `bigclaw-go/internal/regression/big_go_1329_zero_python_guard_test.go`
