...
- Continue the same pattern for the next low-coupling tranche: `cost_control.py`, `legacy_shim.py`, `mapping.py`, `workspace_bootstrap_cli.py`, `github_sync.py`, `workspace_bootstrap_validation.py`, `validation_policy.py`, `event_bus.py`, `memory.py`, and `dsl.py`.
