...
2. Add lane-scoped zero-Python sweep artifacts for `BIG-GO-1306`:
   - `bigclaw-go/docs/reports/big-go-1306-python-asset-sweep.md`
   - `bigclaw-go/internal/regression/big_go_1306_zero_python_guard_test.go`
   - `reports/BIG-GO-1306-status.json`
   - `reports/BIG-GO-1306-validation.md`
...
- `cd bigclaw-go && go test -count=1 ./internal/regression -run 'TestBIGGO1306(RepositoryHasNoPythonFiles|PriorityResidualDirectoriesStayPythonFree|ReplacementPathsRemainAvailable|LaneReportCapturesSweepState)$'`
