...
2. Add lane-scoped zero-Python sweep artifacts for `BIG-GO-1318`:
   - `bigclaw-go/docs/reports/big-go-1318-python-asset-sweep.md`
   - `bigclaw-go/internal/regression/big_go_1318_zero_python_guard_test.go`
   - `reports/BIG-GO-1318-status.json`
   - `reports/BIG-GO-1318-validation.md`
...
- `cd bigclaw-go && go test -count=1 ./internal/regression -run 'TestBIGGO1318(RepositoryHasNoPythonFiles|PriorityResidualDirectoriesStayPythonFree|ReplacementPathsRemainAvailable|LaneReportCapturesSweepState)$'`
