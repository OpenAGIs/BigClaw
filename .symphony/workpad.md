...
2. Add lane-scoped zero-Python sweep artifacts for `BIG-GO-1310`:
   - `bigclaw-go/docs/reports/big-go-1310-python-asset-sweep.md`
   - `bigclaw-go/internal/regression/big_go_1310_zero_python_guard_test.go`
   - `reports/BIG-GO-1310-status.json`
   - `reports/BIG-GO-1310-validation.md`
...
- `cd bigclaw-go && go test -count=1 ./internal/regression -run 'TestBIGGO1310(RepositoryHasNoPythonFiles|PriorityResidualDirectoriesStayPythonFree|ReplacementPathsRemainAvailable|LaneReportCapturesSweepState)$'`
