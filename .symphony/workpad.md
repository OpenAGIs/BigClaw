...
2. Add the lane-scoped `BIG-GO-1334` artifacts for this unattended refill execution:
   - `bigclaw-go/docs/reports/big-go-1334-python-asset-sweep.md`
   - `reports/BIG-GO-1334-status.json`
   - `reports/BIG-GO-1334-validation.md`
   - `bigclaw-go/internal/regression/big_go_1334_zero_python_guard_test.go`
