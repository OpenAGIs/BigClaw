...
- Current repo tranche status as of March 24, 2026:
  - active slices: `BIG-PAR-368` — Broaden direct recovery builder coverage
  - standby slices: none
  - recently completed slices: `BIG-PAR-360` — Extract ClawHost recovery builder for direct inventory coverage; `BIG-PAR-361` — Add ClawHost workflow max helper unit coverage; `BIG-PAR-362` — Add ClawHost workflow report edge-case coverage; `BIG-PAR-363` — Add ClawHost rollout report edge-case coverage; `BIG-PAR-364` — Add ClawHost fleet report edge-case coverage; `BIG-PAR-365` — Add product console unit coverage; `BIG-PAR-366` — Add saved-view helper unit coverage; `BIG-PAR-367` — Add dashboard run contract path helper coverage
