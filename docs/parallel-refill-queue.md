...
- Current repo tranche status as of March 24, 2026:
  - active slices: `BIG-PAR-287` — Add ClawHost fleet inventory and control-plane source; `BIG-PAR-290` — Add ClawHost provider defaults and tenant policy surfaces
  - standby slices: `BIG-PAR-288` — Add parallel ClawHost rollout planner; `BIG-PAR-289` — Add ClawHost skills channels and device approval workflows; `BIG-PAR-291` — Add ClawHost proxy subdomain and admin validation lane
