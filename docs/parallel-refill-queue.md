...
- Current repo tranche status as of March 24, 2026:
  - active slices: `BIG-PAR-358` — Add ClawHost workflow helper unit coverage
  - standby slices: none
  - recently completed slices: `BIG-PAR-350` — Add ClawHost readiness surface unit coverage; `BIG-PAR-351` — Add ClawHost recovery surface unit coverage; `BIG-PAR-352` — Add ClawHost rollout surface unit coverage; `BIG-PAR-353` — Add ClawHost workflow surface payload unit coverage; `BIG-PAR-354` — Add ClawHost parsing helper unit coverage; `BIG-PAR-355` — Add ClawHost policy helper unit coverage; `BIG-PAR-356` — Add ClawHost fleet helper unit coverage; `BIG-PAR-357` — Add ClawHost rollout helper unit coverage
