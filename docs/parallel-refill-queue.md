...
- Current repo tranche status as of March 25, 2026:
  - active slices: `BIG-PAR-316` — Add product regression coverage for fallback ClawHost rollout reports
  - standby slices: none
  - recently completed slices: `BIG-PAR-308` — Add product regression coverage for scoped ClawHost rollout planners; `BIG-PAR-309` — Add product regression coverage for ClawHost workflow review reasons; `BIG-PAR-310` — Add product regression coverage for ClawHost workflow review ordering; `BIG-PAR-311` — Add product regression coverage for idle ClawHost workflow surfaces; `BIG-PAR-312` — Add product regression coverage for ClawHost workflow lane concurrency; `BIG-PAR-313` — Add product regression coverage for idle ClawHost workflow lane signals; `BIG-PAR-314` — Add product regression coverage for empty ClawHost fleet reports; `BIG-PAR-315` — Add product regression coverage for empty ClawHost recovery reports
