...
- The default mainline posture is Go-first, and the dormant legacy
  repo-materialization modules under `src/bigclaw/` have since been removed.
- The remaining Python entry surface is limited to the explicit compatibility
  shim at `src/bigclaw/legacy_shim.py`.
