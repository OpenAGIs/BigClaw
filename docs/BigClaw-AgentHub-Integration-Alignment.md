...
- Incremental:
  - `PYTHONPATH=src python3 -m pytest tests/test_repo_registry.py tests/test_repo_gateway.py`
  - `PYTHONPATH=src python3 -m pytest tests/test_repo_board.py tests/test_repo_governance.py tests/test_repo_triage.py tests/test_service.py`
  - `cd bigclaw-go && go test ./internal/api ./internal/regression`
- Full:
