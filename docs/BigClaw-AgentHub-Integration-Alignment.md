...
- Incremental:
  ...
  - `cd bigclaw-go && go test ./internal/collaboration ./internal/observability ./internal/reportstudio`
  - `cd bigclaw-go && go test ./internal/governance ./internal/triage ./internal/service ./internal/product`
- Full:
