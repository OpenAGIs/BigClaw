...
- retired `scripts/ops/symphony_workspace_bootstrap.py` -> `scripts/ops/bigclawctl workspace ...`
- retired `scripts/ops/bigclaw_refill_queue.py` -> `scripts/ops/bigclawctl refill`
