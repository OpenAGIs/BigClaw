...
- `workflow.md`, `.githooks/post-commit`, and `.githooks/post-rewrite` invoke the Go-first toolchain by default, and the legacy `scripts/ops/bigclaw_github_sync.py`, `scripts/ops/bigclaw_refill_queue.py`, `scripts/ops/symphony_workspace_bootstrap.py`, and `scripts/ops/symphony_workspace_validate.py` wrappers have been removed
- the default operator path is now Go/shell-only via `scripts/ops/bigclawctl`
...
- top-level `python -m bigclaw` entrypoint retired; only importable compatibility modules remain under `src/bigclaw/*`
...
Python source:
- collaboration compatibility surface retired; remaining lineage/collaboration ownership lives under Go repo, flow, and product packages
- `src/bigclaw/repo_board.py`
- `src/bigclaw/repo_commits.py`
- `src/bigclaw/repo_gateway.py`
- `src/bigclaw/repo_governance.py`
...
Python source:
- console and design-system compatibility surfaces retired; remaining operator-console compatibility now lives in `src/bigclaw/operations.py` while Go ownership remains the target end-state
- `src/bigclaw/saved_views.py`
...
- `src/bigclaw/workspace_bootstrap_validation.py`
- `src/bigclaw/service.py`
- top-level `python -m bigclaw` entrypoint
