...
- the remaining default workspace bootstrap path is the Go-first `scripts/ops/bigclawctl workspace ...` entrypoint, and `scripts/ops/symphony_workspace_bootstrap.py` has been retired
