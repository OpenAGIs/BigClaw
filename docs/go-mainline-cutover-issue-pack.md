...
- the former root and ops Python wrappers referenced in this slice were retired in the final cleanup sweep, so the supported operator path is `bash scripts/ops/bigclawctl ...`
