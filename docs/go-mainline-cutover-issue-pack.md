...
- `src/bigclaw/parallel_refill.py` and `src/bigclaw/workspace_bootstrap_cli.py` have been retired because the Go toolchain now owns those operator paths outright
