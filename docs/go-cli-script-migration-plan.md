...
- `scripts/ops/bigclaw_github_sync` -> `bigclawctl github-sync`
- `scripts/ops/bigclaw_refill_queue` -> `bigclawctl refill`
- `scripts/ops/bigclaw_workspace_bootstrap` -> `bigclawctl workspace ...`
