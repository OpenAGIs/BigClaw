...
to invoke `bash scripts/ops/bigclawctl ...` directly. The repo-root and `scripts/ops` Python shims
were removed because the root no longer carries Python packaging/bootstrap ownership.
