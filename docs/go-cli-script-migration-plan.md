...
invoke `bash scripts/ops/bigclawctl ...` directly. The repo-root Python wrappers were removed
...
- Root compatibility retirement:
  repo operators must stop invoking removed repo-root Python shims and use
