...
invoke `bash scripts/ops/bigclawctl ...` directly. The repo-root Python shims and the four legacy
ops Python wrappers have been removed because the root no longer carries Python packaging/bootstrap
ownership.
