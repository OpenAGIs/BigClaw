...
- Shell `scripts/ops/*workspace*` and `scripts/ops/bigclaw_refill_queue` shims only translate legacy flags/defaults before dispatching into `scripts/ops/bigclawctl`.
