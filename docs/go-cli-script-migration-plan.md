...
to invoke `bash scripts/ops/bigclawctl ...` directly. The repo-root and ops Python shims were
...
- Root compatibility retirement:
  repo operators must stop invoking removed repo-root and ops Python shims and switch to
