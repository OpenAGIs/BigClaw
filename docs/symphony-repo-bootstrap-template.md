...
The shell entrypoint is generic. Repositories that still retain Python
compatibility assets can keep them as migration-only surfaces, but the
bootstrap path itself should now be Go or shell-first.
