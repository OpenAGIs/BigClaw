...
The shell entrypoint is generic and Go-owned. Repo-specific migration shims are no longer required for bootstrap or validation once `bigclawctl workspace` is present.
