...
def main() -> int:
    ...
    args = append_missing_flag(sys.argv[1:], "--repo-url", os.getenv("BIGCLAW_BOOTSTRAP_REPO_URL", DEFAULT_REPO_URL))
    args = append_missing_flag(args, "--cache-key", os.getenv("BIGCLAW_BOOTSTRAP_CACHE_KEY", DEFAULT_CACHE_KEY))
