#!/usr/bin/env python3
"""Frozen Python live-shadow comparison harness pending a Go-native replacement.

Removal condition: delete after a Go command owns primary-vs-shadow comparison
and migration docs stop referencing this Python entrypoint.
"""
...
GO_MAINLINE_REPLACEMENT = "bigclaw-go/cmd/bigclawctl migration shadow-compare"
REMOVAL_CONDITION = (
    "Delete after a Go CLI command replaces this live-shadow comparison harness "
    "and migration docs stop referencing the Python script."
)
