...
def build_report(
    ...
    if 'shared_queue_companion_available' in failing_checks:
        next_actions.append('rerun `scripts/e2e/multi_node_shared_queue --report-path docs/reports/multi-node-shared-queue-report.json`')
    ...
    return {
        ...
        'evidence_inputs': {
            ...
            'generator_script': 'scripts/e2e/validation_bundle_continuation_policy_gate',
        },
        'policy_inputs': {
