#!/usr/bin/env python3
"""Frozen Python e2e harness pending a Go-native replacement.

Removal condition: delete after a Go e2e command owns mixed-workload routing
validation and repo docs stop referencing this Python harness.
"""
...
GO_MAINLINE_REPLACEMENT = "bigclaw-go/cmd/bigclawctl e2e mixed-workload-matrix"
REMOVAL_CONDITION = (
    "Delete after a Go CLI/e2e command replaces this harness and documentation "
    "no longer references the Python script."
)
