...
- `go run ./cmd/bigclawctl automation e2e run-task-smoke ...` is the generic submit/poll entrypoint used by the smoke wrappers
...
- Full instructions live in `docs/e2e-validation.md`, `docs/migration-shadow.md`, and `../docs/go-only-repo-cutover.md`
