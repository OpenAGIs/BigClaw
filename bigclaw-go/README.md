...
- `go run ./cmd/bigclawctl automation e2e run-task-smoke ...` is the generic submit/poll helper used by the smoke wrappers
- `go run ./scripts/e2e/export_validation_bundle.go ...` exports repo-native evidence bundles, latest report copies, and the validation index
