...
- `scripts/migration/shadow_compare.py` compares primary vs shadow BigClaw endpoints and writes normalized migration-shadow bundle metadata
- `scripts/migration/shadow_matrix.py` runs the same normalized bundle flow across multiple task fixtures
