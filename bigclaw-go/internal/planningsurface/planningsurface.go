		...
		Candidates: []CandidateEntry{
			{
				...
				ValidationCommand: "cd bigclaw-go && go test ./internal/product ./internal/regression",
				...
				EvidenceLinks: []EvidenceLink{
					...
					{Label: "ui-acceptance-tests", Target: "bigclaw-go/internal/product/console_test.go", Capability: "release-gate", Note: "repo-native design-system and console helper coverage"},
					{Label: "console-shell-tests", Target: "bigclaw-go/internal/product/console_test.go", Capability: "release-gate", Note: "repo-native console navigation and shell coverage"},
					{Label: "review-pack-tests", Target: "bigclaw-go/internal/regression/residual_python_tests_tranche3_test.go", Capability: "release-gate", Note: "repo-native guard that keeps tranche-3 Python review tests removed"},
				},
			},
			{
				...
				ValidationCommand: "PYTHONPATH=src python3 -m pytest tests/test_control_center.py tests/test_saved_views.py tests/test_evaluation.py -q && (cd bigclaw-go && go test ./internal/reporting ./internal/worker ./internal/workflow ./internal/scheduler)",
				...
				EvidenceLinks: []EvidenceLink{
					...
					{Label: "operations-tests", Target: "bigclaw-go/internal/reporting/reporting_test.go", Capability: "ops-control", Note: "repo-native dashboard, weekly report, regression, and version-center coverage"},
			...
			},
			{
				...
				ValidationCommand: "PYTHONPATH=src python3 -m pytest tests/test_orchestration.py -q && (cd bigclaw-go && go test ./internal/reporting)",
				...
				EvidenceLinks: []EvidenceLink{
					...
					{Label: "report-studio-tests", Target: "bigclaw-go/internal/reporting/reporting_test.go", Capability: "commercialization", Note: "repo-native report exports and downstream evidence sharing"},
				},
			},
		},
	}
