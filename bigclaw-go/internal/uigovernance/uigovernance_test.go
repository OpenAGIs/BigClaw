...
func TestRenderUIReviewPackReportCoversDesignSprintReviewPack(t *testing.T) {
	pack := BuildBIG4204ReviewPack()
	audit := (UIReviewPackAuditor{}).Audit(pack)

	if !audit.Ready {
		t.Fatalf("expected audit to be ready: %+v", audit)
	}
	...
	for _, fragment := range []string{
		...
		"## Role Matrix",
		"role-queue-platform-admin: surface=wf-queue role=Platform Admin status=ready",
		"## Role Coverage Board",
		...
		"## Sign-off Log",
		"sig-run-detail-eng-lead: surface=wf-run-detail role=Eng Lead assignment=role-run-detail-eng-lead status=pending",
		"## Review Exceptions",
		...
		"## Blocker Timeline",
		"evt-run-detail-copy-escalated: blocker=blk-run-detail-copy-final actor=design-program-manager status=escalated at=2026-03-14T09:30:00Z",
		...
		"- Checklist items missing role links: none",
		"- Wireframes missing decision coverage: none",
		"- Unresolved decisions missing follow-ups: none",
		"- Wireframes missing role assignments: none",
		"- Wireframes missing signoff coverage: none",
		"- Blockers missing signoff links: none",
		"- Freeze exceptions missing owners: none",
		"- Freeze exceptions missing windows: none",
		"- Freeze exceptions missing approvers: none",
		"- Freeze exceptions missing approval dates: none",
		"- Freeze exceptions missing renewal owners: none",
		"- Freeze exceptions missing renewal dates: none",
		"- Blockers missing timeline events: none",
		"- Closed blockers missing resolution events: none",
		"- Orphan blocker timeline blocker ids: none",
		"- Handoff events missing targets: none",
		"- Handoff events missing artifacts: none",
		"- Handoff events missing ack owners: none",
		"- Handoff events missing ack dates: none",
		"- Unresolved required signoffs without blockers: none",
		"- Unresolved decision ids: dec-queue-vp-summary",
		"- Decisions missing role links: none",
		"- Signoffs missing requested dates: none",
		"- Signoffs missing due dates: none",
		"- Signoffs missing escalation owners: none",
		"- Signoffs missing reminder owners: none",
		"- Signoffs missing next reminders: none",
		"- Signoffs missing reminder cadence: none",
		"- Signoffs with breached SLA: none",
