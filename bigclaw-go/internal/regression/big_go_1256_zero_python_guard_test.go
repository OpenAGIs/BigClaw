...
func TestBIGGO1256RepositoryHasNoPythonFiles(t *testing.T) {
...
func TestBIGGO1256PriorityResidualDirectoriesStayPythonFree(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
...
func TestBIGGO1256ReplacementPathsRemainAvailable(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
