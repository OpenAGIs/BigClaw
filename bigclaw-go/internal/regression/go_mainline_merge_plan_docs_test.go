	...
	cases := []struct {
	...
	}{
		{
			...
			substrings: []string{
				...
				"`origin/codex/big-go-901-migration-inventory`",
				"`origin/feat/BIG-GO-902-go-cli-script-migration`",
				"`origin/BIG-GO-903`",
				"`origin/codex/BIG-GO-904-control-plane-go-only-slice`",
				"`origin/big-go-905`",
				"`origin/codex/BIG-GO-906-runtime-scheduler-orchestration-migration`",
				"`origin/symphony/BIG-GO-908`",
				"`origin/symphony/BIG-GO-909`",
				"`BIG-GO-907` was not visible from `origin`",
				"`symphony/BIG-GO-910`",
