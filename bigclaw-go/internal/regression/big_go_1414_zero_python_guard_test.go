...
func TestBIGGO1414RepositoryHasNoPythonFiles(t *testing.T) {
...
func TestBIGGO1414PriorityResidualDirectoriesStayPythonFree(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
...
func TestBIGGO1414GoReplacementPathsRemainAvailable(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
...
func TestBIGGO1414LaneReportCapturesSweepState(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
	report := readRepoFile(t, rootRepo, "bigclaw-go/docs/reports/big-go-1414-python-asset-sweep.md")
	...
	for _, needle := range []string{
		...
		"`cd /Users/openagi/code/bigclaw-workspaces/BIG-GO-1414/bigclaw-go && go test -count=1 ./internal/regression -run 'TestBIGGO1414",
	} {
