...
func TestBIGGO1246RepositoryHasNoPythonFiles(t *testing.T) {
...
func TestBIGGO1246PriorityResidualDirectoriesStayPythonFree(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
...
func TestBIGGO1246ReplacementPathsRemainAvailable(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
