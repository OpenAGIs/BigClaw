...
func TestBIGGO1240RepositoryHasNoPythonFiles(t *testing.T) {
...
func TestBIGGO1240PriorityResidualDirectoriesStayPythonFree(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
...
func TestBIGGO1240ReplacementPathsRemainAvailable(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
