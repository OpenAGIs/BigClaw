...
func TestBIGGO1247RepositoryHasNoPythonFiles(t *testing.T) {
...
func TestBIGGO1247PriorityResidualDirectoriesStayPythonFree(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
...
func TestBIGGO1247ReplacementPathsRemainAvailable(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
