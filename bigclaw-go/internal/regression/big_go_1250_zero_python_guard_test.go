...
func TestBIGGO1250RepositoryHasNoPythonFiles(t *testing.T) {
...
func TestBIGGO1250PriorityResidualDirectoriesStayPythonFree(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
...
func TestBIGGO1250ReplacementPathsRemainAvailable(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
