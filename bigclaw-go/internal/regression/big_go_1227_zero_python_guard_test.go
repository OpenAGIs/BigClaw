...
func TestBIGGO1227RepositoryHasNoPythonFiles(t *testing.T) {
...
func TestBIGGO1227PriorityResidualDirectoriesStayPythonFree(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
...
func TestBIGGO1227ReplacementPathsRemainAvailable(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
