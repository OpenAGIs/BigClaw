...
func TestTopLevelModulePurgeTranche2RemovesRepoCollaborationPythonModules(t *testing.T) {
	root := repoRoot(t)
...
func TestTopLevelModulePurgeTranche2RepoCollaborationGoOwnershipDocsStayAligned(t *testing.T) {
	root := repoRoot(t)
