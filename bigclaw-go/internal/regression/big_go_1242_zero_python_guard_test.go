...
func TestBIGGO1242RepositoryHasNoPythonFiles(t *testing.T) {
...
func TestBIGGO1242PriorityResidualDirectoriesStayPythonFree(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
...
func TestBIGGO1242ReplacementPathsRemainAvailable(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
