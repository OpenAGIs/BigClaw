...
func TestBIGGO1248RepositoryHasNoPythonFiles(t *testing.T) {
...
func TestBIGGO1248PriorityResidualDirectoriesStayPythonFree(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
...
func TestBIGGO1248ReplacementPathsRemainAvailable(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
