...
func TestBIGGO1245RepositoryHasNoPythonFiles(t *testing.T) {
...
func TestBIGGO1245PriorityResidualDirectoriesStayPythonFree(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
...
func TestBIGGO1245ReplacementPathsRemainAvailable(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
