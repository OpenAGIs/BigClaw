...
func TestBIGGO1315RepositoryHasNoPythonFiles(t *testing.T) {
...
func TestBIGGO1315PriorityResidualDirectoriesStayPythonFree(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
...
func TestBIGGO1315LaneReportCapturesSweepState(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
	report := readRepoFile(t, rootRepo, "bigclaw-go/docs/reports/big-go-1315-python-asset-sweep.md")
