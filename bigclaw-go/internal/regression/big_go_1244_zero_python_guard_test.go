...
func TestBIGGO1244RepositoryHasNoPythonFiles(t *testing.T) {
...
func TestBIGGO1244PriorityResidualDirectoriesStayPythonFree(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
...
func TestBIGGO1244ReplacementPathsRemainAvailable(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
