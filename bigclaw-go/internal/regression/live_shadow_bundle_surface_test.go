...
func TestLiveShadowScorecardBundleStaysAligned(t *testing.T) {
	...
	if canonical.EvidenceInputs.GeneratorScript != "checked_in_repo_native_live_shadow_evidence" {
...
func TestLiveShadowBundleSummaryAndIndexStayAligned(t *testing.T) {
	...
	for _, command := range []string{
		"go test ./internal/regression -run TestLiveShadowBundleSummaryAndIndexStayAligned",
