...
func TestLiveShadowScorecardBundleStaysAligned(t *testing.T) {
	...
	if canonical.EvidenceInputs.GeneratorScript != "bigclaw-go/scripts/migration/live_shadow_scorecard/main.go" {
...
func TestLiveShadowBundleSummaryAndIndexStayAligned(t *testing.T) {
	...
	for _, command := range []string{
		"go run ./scripts/migration/live_shadow_scorecard --pretty",
		"go run ./scripts/migration/export_live_shadow_bundle",
