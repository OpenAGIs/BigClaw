...
func TestBIGGO1213RepositoryHasNoPythonFiles(t *testing.T) {
...
func TestBIGGO1213PriorityResidualDirectoriesStayPythonFree(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
...
func TestBIGGO1213ReplacementPathsRemainAvailable(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
