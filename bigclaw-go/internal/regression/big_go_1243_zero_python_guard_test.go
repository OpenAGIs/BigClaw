...
func TestBIGGO1243RepositoryHasNoPythonFiles(t *testing.T) {
...
func TestBIGGO1243PriorityResidualDirectoriesStayPythonFree(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
...
func TestBIGGO1243ReplacementPathsRemainAvailable(t *testing.T) {
	rootRepo := regressionRepoRoot(t)
