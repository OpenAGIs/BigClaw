...
const LegacyOperatorWrapperNotice = "Legacy operator wrapper: use scripts/ops/bigclawctl for the Go mainline. Thin shell entrypoints remain only for compatibility during migration."
