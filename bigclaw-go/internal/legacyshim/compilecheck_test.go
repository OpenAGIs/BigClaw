...
func TestFrozenCompileCheckFilesUsesFrozenShimList(t *testing.T) {
	...
	want := []string{
		filepath.Join(repoRoot, "src/bigclaw/design_system.py"),
		filepath.Join(repoRoot, "src/bigclaw/models.py"),
		filepath.Join(repoRoot, "src/bigclaw/repo_gateway.py"),
		...
		filepath.Join(repoRoot, "tests/conftest.py"),
		filepath.Join(repoRoot, "tests/test_evaluation.py"),
		filepath.Join(repoRoot, "bigclaw-go/scripts/benchmark/capacity_certification.py"),
		filepath.Join(repoRoot, "bigclaw-go/scripts/e2e/mixed_workload_matrix.py"),
		filepath.Join(repoRoot, "bigclaw-go/scripts/migration/shadow_compare.py"),
	}
