		...
		Candidates: []CandidateEntry{
			...
			},
			{
				...
				EvidenceLinks: []EvidenceLink{
					...
					{Label: "command-center-tests", Target: "bigclaw-go/internal/product/console_test.go", Capability: "ops-control", Note: "Go-native queue control center and console validation"},
