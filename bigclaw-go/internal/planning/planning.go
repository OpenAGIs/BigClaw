		...
		Candidates: []CandidateEntry{
			{
				...
				ValidationCommand: "go test ./internal/designsystem ./internal/consoleia ./internal/uireview",
			...
			},
			{
				...
				ValidationCommand: "go test ./internal/contract ./internal/evaluation ./internal/product ./internal/worker ./internal/workflow ./internal/scheduler",
				...
				EvidenceLinks: []EvidenceLink{
					...
					{Label: "operations-tests", Target: "bigclaw-go/internal/product/console_test.go", Capability: "ops-control", Note: "Go-native dashboard, weekly report, regression, and version-center coverage"},
					{Label: "approval-contract", Target: "bigclaw-go/internal/contract/execution_test.go", Capability: "ops-control", Note: "Go-native approval permission and API role coverage contract"},
					{Label: "approval-workflow", Target: "bigclaw-go/internal/workflow/closeout_test.go", Capability: "ops-control", Note: "Go-native approval workflow and closeout flow wiring"},
			...
			},
			{
				...
				ValidationCommand: "go test ./internal/collaboration ./internal/pilot ./internal/reportstudio",
				Capabilities:      []string{"commercialization", "handoff", "pilot-rollout"},
				Evidence:          []string{"pilot-evidence", "validation-report"},
				EvidenceLinks: []EvidenceLink{
					{Label: "orchestration-plan-src", Target: "src/bigclaw/collaboration.py", Capability: "commercialization", Note: "cross-team orchestration, entitlement-aware policy, and handoff decisions"},
