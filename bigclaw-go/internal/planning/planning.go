		...
		Candidates: []CandidateEntry{
			...
			},
			{
				...
				EvidenceLinks: []EvidenceLink{
					...
					{Label: "simulation-src", Target: "src/bigclaw/operations.py", Capability: "rollback-simulation", Note: "simulation, replay, comparison evidence, and operator dashboard context"},
