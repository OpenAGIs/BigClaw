		...
		Candidates: []CandidateEntry{
			{
				...
				EvidenceLinks: []EvidenceLink{
					{Label: "design-system-surface", Target: "bigclaw-go/internal/designsystem/designsystem.go", Capability: "release-gate", Note: "Go-native component inventory, accessibility, and UI acceptance contracts"},
					{Label: "console-ia-surface", Target: "bigclaw-go/internal/consoleia/consoleia.go", Capability: "release-gate", Note: "Go-native global navigation, top bar, filters, and state contracts"},
					{Label: "ui-review-surface", Target: "bigclaw-go/internal/uireview/uireview.go", Capability: "release-gate", Note: "Go-native review objectives, wireframes, interaction coverage, and open questions"},
