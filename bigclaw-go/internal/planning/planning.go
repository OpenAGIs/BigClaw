		...
		Candidates: []CandidateEntry{
			{
				...
				EvidenceLinks: []EvidenceLink{
					{Label: "design-system-contract", Target: "bigclaw-go/internal/designsystem/designsystem.go", Capability: "release-gate", Note: "Go-owned component inventory, accessibility, and UI acceptance contract"},
					{Label: "console-ia-contract", Target: "bigclaw-go/internal/consoleia/consoleia.go", Capability: "release-gate", Note: "Go-owned global navigation, top bar, filters, and state contracts"},
					{Label: "ui-review-pack", Target: "bigclaw-go/internal/uireview/uireview.go", Capability: "release-gate", Note: "Go-owned review objectives, wireframes, interaction coverage, and open questions"},
