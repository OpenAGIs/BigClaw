		...
		Candidates: []CandidateEntry{
			...
			},
			{
				...
				EvidenceLinks: []EvidenceLink{
					...
					{Label: "orchestration-report-go", Target: "bigclaw-go/internal/reportstudio/reportstudio.go", Capability: "commercialization", Note: "Go-native orchestration canvas, portfolio rollups, and narrative exports"},
