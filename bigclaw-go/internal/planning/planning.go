	...
	return CandidateBacklog{
		...
		Candidates: []CandidateEntry{
			...
			},
			{
				...
				EvidenceLinks: []EvidenceLink{
					{Label: "command-center-src", Target: "bigclaw-go/internal/product/dashboard_run_contract.go", Capability: "ops-control", Note: "queue control center, dashboard builder, weekly review, and regression surfaces"},
			...
			},
			{
				...
				EvidenceLinks: []EvidenceLink{
					{Label: "orchestration-plan-src", Target: "bigclaw-go/internal/collaboration/thread.go", Capability: "commercialization", Note: "cross-team orchestration, entitlement-aware policy, and handoff decisions"},
