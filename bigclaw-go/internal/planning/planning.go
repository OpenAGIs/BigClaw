		...
		Candidates: []CandidateEntry{
			{
				...
				ValidationCommand: "(cd bigclaw-go && go test ./internal/uireview ./internal/product)",
				Capabilities:      []string{"release-gate", "console-shell", "reporting"},
				Evidence:          []string{"acceptance-suite", "validation-report"},
				EvidenceLinks: []EvidenceLink{
					{Label: "design-system-audit", Target: "bigclaw-go/internal/uireview/builder.go", Capability: "release-gate", Note: "component inventory, accessibility, and UI acceptance coverage"},
					{Label: "console-ia-contract", Target: "bigclaw-go/internal/product/console.go", Capability: "release-gate", Note: "global navigation, top bar, filters, and state contracts"},
					...
					{Label: "ui-acceptance-tests", Target: "bigclaw-go/internal/uireview/uireview_test.go", Capability: "release-gate", Note: "role-permission, data accuracy, and performance audits"},
					{Label: "console-shell-tests", Target: "bigclaw-go/internal/product/console_test.go", Capability: "release-gate", Note: "console shell and interaction draft release readiness"},
			...
			},
			{
				...
				ValidationCommand: "(cd bigclaw-go && go test ./internal/evaluation ./internal/product ./internal/worker ./internal/workflow ./internal/scheduler ./internal/contract)",
				Capabilities:      []string{"ops-control", "saved-views", "rollback-simulation"},
				Evidence:          []string{"weekly-review", "validation-report"},
				EvidenceLinks: []EvidenceLink{
					{Label: "command-center-src", Target: "bigclaw-go/internal/product/console.go", Capability: "ops-control", Note: "queue control center, dashboard builder, weekly review, and regression surfaces"},
					{Label: "operations-tests", Target: "bigclaw-go/internal/product/console_test.go", Capability: "ops-control", Note: "dashboard, weekly report, regression, and version-center coverage"},
					{Label: "approval-contract", Target: "bigclaw-go/internal/contract/execution.go", Capability: "ops-control", Note: "approval permission and API role coverage contract"},
					{Label: "approval-workflow", Target: "bigclaw-go/internal/workflow/engine.go", Capability: "ops-control", Note: "approval workflow and closeout flow wiring"},
					...
					{Label: "saved-views-src", Target: "bigclaw-go/internal/product/saved_views.go", Capability: "saved-views", Note: "saved views, digest subscriptions, and governed filters"},
					...
					{Label: "simulation-src", Target: "bigclaw-go/internal/evaluation/evaluation.go", Capability: "rollback-simulation", Note: "simulation, replay, and comparison evidence"},
			...
			},
			{
				...
				EvidenceLinks: []EvidenceLink{
					...
					{Label: "orchestration-report-src", Target: "bigclaw-go/internal/reportstudio/reportstudio.go", Capability: "commercialization", Note: "orchestration canvas, portfolio rollups, and narrative exports"},
					...
					{Label: "report-studio-tests", Target: "bigclaw-go/internal/reportstudio/reportstudio_test.go", Capability: "commercialization", Note: "report exports and downstream evidence sharing"},
				},
			},
		},
	}
