		...
		Candidates: []CandidateEntry{
			{
				...
				EvidenceLinks: []EvidenceLink{
					...
					{Label: "console-shell-tests", Target: "bigclaw-go/internal/product/console_test.go", Capability: "release-gate", Note: "Go-native console shell and navigation coverage"},
			...
			},
			{
				...
				EvidenceLinks: []EvidenceLink{
					...
					{Label: "operations-tests", Target: "bigclaw-go/internal/product/console_test.go", Capability: "ops-control", Note: "Go-native dashboard, queue control, and operator workflow coverage"},
			...
			},
			{
				...
				ValidationCommand: "go test ./internal/collaboration ./internal/pilot",
				...
				EvidenceLinks: []EvidenceLink{
					...
					{Label: "report-studio-tests", Target: "bigclaw-go/internal/pilot/report_test.go", Capability: "commercialization", Note: "Go-native report exports and downstream evidence sharing"},
				},
			},
		},
	}
