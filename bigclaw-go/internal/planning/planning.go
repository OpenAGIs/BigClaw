		...
		Candidates: []CandidateEntry{
			{
				...
				EvidenceLinks: []EvidenceLink{
					{Label: "design-system-audit", Target: "bigclaw-go/internal/designsystem/designsystem.go", Capability: "release-gate", Note: "Go-owned component inventory, accessibility, and UI acceptance contracts"},
