		...
		Candidates: []CandidateEntry{
			{
				...
				ValidationCommand: "(cd bigclaw-go && go test ./internal/designsystem ./internal/consoleia ./internal/uireview)",
				Capabilities:      []string{"release-gate", "console-shell", "reporting"},
				Evidence:          []string{"acceptance-suite", "validation-report"},
				EvidenceLinks: []EvidenceLink{
					{Label: "design-system-audit", Target: "bigclaw-go/internal/designsystem/designsystem_test.go", Capability: "release-gate", Note: "Go-native component inventory, accessibility, and UI acceptance coverage"},
					{Label: "console-ia-contract", Target: "bigclaw-go/internal/consoleia/consoleia.go", Capability: "release-gate", Note: "Go-native global navigation, top bar, filters, and state contracts"},
					{Label: "ui-review-pack", Target: "bigclaw-go/internal/uireview/uireview.go", Capability: "release-gate", Note: "Go-native review objectives, wireframes, interaction coverage, and open questions"},
			...
			},
			{
				...
				ValidationCommand: "(cd bigclaw-go && go test ./internal/evaluation ./internal/product ./internal/worker ./internal/workflow ./internal/scheduler)",
				Capabilities:      []string{"ops-control", "saved-views", "rollback-simulation"},
				Evidence:          []string{"weekly-review", "validation-report"},
				EvidenceLinks: []EvidenceLink{
					{Label: "command-center-src", Target: "bigclaw-go/internal/product/console.go", Capability: "ops-control", Note: "Go-native queue control center, dashboard builder, weekly review, and regression surfaces"},
					...
					{Label: "approval-contract", Target: "bigclaw-go/internal/contract/execution.go", Capability: "ops-control", Note: "Go-native approval permission and API role coverage contract"},
					{Label: "approval-workflow", Target: "bigclaw-go/internal/workflow/engine.go", Capability: "ops-control", Note: "Go-native approval workflow and closeout flow wiring"},
					...
					{Label: "saved-views-src", Target: "bigclaw-go/internal/product/saved_views.go", Capability: "saved-views", Note: "Go-native saved views, digest subscriptions, and governed filters"},
			...
			},
			{
				...
				EvidenceLinks: []EvidenceLink{
					{Label: "orchestration-plan-src", Target: "bigclaw-go/internal/workflow/orchestration.go", Capability: "commercialization", Note: "Go-native cross-team orchestration, entitlement-aware policy, and handoff decisions"},
					{Label: "orchestration-report-src", Target: "bigclaw-go/internal/reporting/reporting.go", Capability: "commercialization", Note: "Go-native orchestration canvas, portfolio rollups, and narrative exports"},
