		...
		Candidates: []CandidateEntry{
			{
				...
				ValidationCommand: "cd bigclaw-go && go test ./internal/designsystemparity ./internal/consoleiaparity ./internal/reviewparity",
				...
				EvidenceLinks: []EvidenceLink{
					...
					{Label: "review-pack-tests", Target: "bigclaw-go/internal/reviewparity/reviewparity_test.go", Capability: "release-gate", Note: "deterministic review packet validation"},
				},
			},
			{
			...
			},
			{
				...
				ValidationCommand: "cd bigclaw-go && go test ./internal/workflow ./internal/reportingparity",
				...
				EvidenceLinks: []EvidenceLink{
					...
					{Label: "report-studio-tests", Target: "bigclaw-go/internal/reportingparity/reportingparity_test.go", Capability: "commercialization", Note: "report exports and downstream evidence sharing"},
				},
			},
		},
	}
