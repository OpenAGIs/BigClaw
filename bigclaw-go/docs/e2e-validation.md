...
```bash
cd bigclaw-go
go run ./scripts/e2e/validation_bundle_continuation_scorecard/main.go --pretty
```
...
```bash
cd bigclaw-go
go run ./scripts/e2e/validation_bundle_continuation_policy_gate/main.go --pretty
```
