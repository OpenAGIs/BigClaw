...
```bash
cd bigclaw-go
go run ./cmd/bigclawctl automation e2e validation-bundle-continuation-scorecard --pretty
```
...
```bash
cd bigclaw-go
go run ./cmd/bigclawctl automation e2e validation-bundle-continuation-policy-gate --pretty
```
