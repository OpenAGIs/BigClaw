...
- Run date: 2026-03-13
- Command: `go run ./cmd/bigclawctl automation benchmark soak-local --autostart --count 1000 --workers 24 --timeout-seconds 300 --report-path docs/reports/soak-local-1000x24.json`
