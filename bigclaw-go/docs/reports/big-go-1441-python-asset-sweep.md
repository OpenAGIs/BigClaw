# BIG-GO-1441 Python Asset Sweep

## Scope

Heartbeat refill lane `BIG-GO-1441` records the remaining Python asset
...
- `cd bigclaw-go && go test -count=1 ./internal/regression -run 'TestBIGGO1441(RepositoryHasNoPythonFiles|PriorityResidualDirectoriesStayPythonFree|GoReplacementPathsRemainAvailable|LaneReportCapturesSweepState)$'`
