...
- Run date: 2026-03-13
- Commands:
  - `go run ./scripts/benchmark/run_matrix --scenario 50:8 --scenario 100:12 --report-path docs/reports/benchmark-matrix-report.json`
  - `go run ./scripts/benchmark/soak_local --autostart --count 2000 --workers 24 --timeout-seconds 480 --report-path docs/reports/soak-local-2000x24.json`
...
- `scripts/benchmark/run_matrix/main.go`
