...
- Run date: 2026-03-13
- Commands:
  - `bigclawctl automation benchmark run-matrix --scenario 50:8 --scenario 100:12 --report-path docs/reports/benchmark-matrix-report.json`
  - `bigclawctl automation benchmark soak-local --autostart --count 2000 --workers 24 --timeout-seconds 480 --report-path docs/reports/soak-local-2000x24.json`
...
- `bigclawctl automation benchmark run-matrix` (generates `docs/reports/benchmark-matrix-report.json`)
- `bigclawctl automation benchmark capacity-certification` (generates the capacity certification artifacts)
