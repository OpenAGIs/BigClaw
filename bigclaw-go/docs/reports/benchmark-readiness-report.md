...
- Run date: 2026-03-13
- Commands:
  - `go run ./cmd/bigclawctl automation benchmark run-matrix --scenario 50:8 --scenario 100:12 --report-path docs/reports/benchmark-matrix-report.json`
...
- `cmd/bigclawctl/benchmark_material.go`
