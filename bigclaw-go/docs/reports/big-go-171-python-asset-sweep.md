# BIG-GO-171 Python Asset Sweep

## Scope

Residual `src/bigclaw` Python sweep N for `BIG-GO-171` records the remaining
physical Python asset inventory for the repository and keeps the priority
residual directories Go-only.
