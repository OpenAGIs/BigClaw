# BIG-GO-113 Python Asset Sweep

## Scope

Residual tests cleanup lane `BIG-GO-113` records the remaining Python asset baseline with explicit focus on `src/bigclaw`, `tests`, `scripts`, and `bigclaw-go/scripts`.
