# BIG-GO-198 Python Asset Sweep

## Scope

`BIG-GO-198` (`Broad repo Python reduction sweep AD`) records the remaining
...
- `cd bigclaw-go && go test -count=1 ./internal/regression -run 'TestBIGGO198(RepositoryHasNoPythonFiles|PriorityResidualDirectoriesStayPythonFree|GoReplacementPathsRemainAvailable|LaneReportCapturesSweepState)$'`
