...
- `go run ./cmd/bigclawctl automation e2e continuation-scorecard ...` regenerates the scorecard from checked-in bundle summaries and shared-queue evidence.
...
- `go run ./cmd/bigclawctl automation e2e continuation-policy-gate ...` evaluates the scorecard as a repo-native policy gate.
