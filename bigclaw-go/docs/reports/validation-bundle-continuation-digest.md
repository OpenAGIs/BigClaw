...
- `scripts/e2e/validation_bundle_continuation_scorecard/main.go` regenerates the scorecard from checked-in bundle summaries and shared-queue evidence.
...
- `scripts/e2e/validation_bundle_continuation_policy_gate/main.go` evaluates the scorecard as a repo-native policy gate.
