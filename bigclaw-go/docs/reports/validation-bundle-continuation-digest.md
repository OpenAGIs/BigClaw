...
- `go run ./cmd/bigclawctl e2e validation-bundle-continuation-scorecard` regenerates the scorecard from checked-in bundle summaries and shared-queue evidence.
...
- `go run ./cmd/bigclawctl e2e validation-bundle-continuation-policy-gate` evaluates the scorecard as a repo-native policy gate.
