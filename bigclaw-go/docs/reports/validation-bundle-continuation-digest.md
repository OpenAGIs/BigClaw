...
- `scripts/e2e/validation_bundle_continuation_scorecard.go` regenerates the scorecard from checked-in bundle summaries and shared-queue evidence.
...
- `scripts/e2e/validation_bundle_continuation_policy_gate.go` evaluates the scorecard as a repo-native policy gate.
