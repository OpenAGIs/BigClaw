...
- `go run ./cmd/bigclawctl automation e2e validation-bundle-continuation-scorecard --pretty` regenerates the scorecard from checked-in bundle summaries and shared-queue evidence.
...
- `go run ./cmd/bigclawctl automation e2e validation-bundle-continuation-policy-gate --pretty` evaluates the scorecard as a repo-native policy gate.
