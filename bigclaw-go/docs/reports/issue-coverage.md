...
- `OPE-184` / `BIG-GO-009`
  - Covered by `internal/observability/recorder.go`, `internal/observability/recorder_test.go`, `internal/observability/audit.go`, `internal/observability/audit_test.go`, `internal/api/server.go`, `internal/api/server_test.go`, `internal/worker/runtime.go`, `cmd/bigclawctl/automation_commands.go`, `cmd/bigclawctl/automation_commands_test.go`, `docs/reports/go-control-plane-observability-report.md`, `scripts/e2e/run_all.sh`, and isolated autostart live-validation reports in `docs/reports/*.json`
