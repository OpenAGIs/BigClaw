...
- `OPE-185` / `BIG-GO-010`
  - Covered by `docs/migration.md`, `docs/migration-shadow.md`, `scripts/migration/shadow_compare.py`, `scripts/migration/shadow_matrix.py`, `go run ./cmd/bigclawctl migration live-shadow-scorecard`, `examples/shadow-corpus-manifest.json`, `docs/reports/migration-readiness-report.md`, `docs/reports/shadow-compare-report.json`, `docs/reports/shadow-matrix-report.json`, `docs/reports/live-shadow-mirror-scorecard.json`, and `docs/reports/control-plane-go-only-migration-plan.md`
