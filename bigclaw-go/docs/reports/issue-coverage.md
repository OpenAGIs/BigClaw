...
- `OPE-185` / `BIG-GO-010`
  - Covered by `docs/migration.md`, `docs/migration-shadow.md`, `scripts/migration/shadow_compare.py`, `scripts/migration/shadow_matrix.py`, `internal/reporting/live_shadow.go`, `internal/reporting/live_shadow_test.go`, `scripts/migration/live_shadow_scorecard/main.go`, `scripts/migration/export_live_shadow_bundle/main.go`, `examples/shadow-corpus-manifest.json`, `docs/reports/migration-readiness-report.md`, `docs/reports/shadow-compare-report.json`, `docs/reports/shadow-matrix-report.json`, `docs/reports/live-shadow-mirror-scorecard.json`, and `docs/reports/live-shadow-index.json`
