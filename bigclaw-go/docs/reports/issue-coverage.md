...
- `OPE-186` / `BIG-GO-011`
  - Covered by `internal/queue/benchmark_test.go`, `internal/scheduler/benchmark_test.go`, `cmd/bigclawctl/automation_commands.go`, `cmd/bigclawctl/automation_commands_test.go`, `cmd/bigclawctl/benchmark_material.go`, `docs/benchmark-plan.md`, `docs/reports/benchmark-report.md`, `docs/reports/benchmark-readiness-report.md`, `docs/reports/benchmark-matrix-report.json`, `docs/reports/long-duration-soak-report.md`, `docs/reports/soak-local-report.json`, `docs/reports/soak-local-50x8.json`, `docs/reports/soak-local-100x12.json`, `docs/reports/soak-local-1000x24.json`, `docs/reports/soak-local-2000x24.json`, `docs/reports/live-validation-summary.json`, `scripts/benchmark/run_suite.sh`, and `scripts/e2e/run_all.sh`
- `OPE-3` / `BIG-PAR-098`
  - Covered by `cmd/bigclawctl/automation_commands.go`, `cmd/bigclawctl/automation_commands_test.go`, `cmd/bigclawctl/benchmark_material.go`, `docs/benchmark-plan.md`, `docs/reports/capacity-certification-report.md`, `docs/reports/capacity-certification-matrix.json`, `docs/reports/benchmark-readiness-report.md`, `docs/reports/long-duration-soak-report.md`, and `docs/reports/mixed-workload-matrix-report.json`
