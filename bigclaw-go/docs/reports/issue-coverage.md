...
- `OPE-185` / `BIG-GO-010`
  - Covered by `docs/migration.md`, `docs/migration-shadow.md`, `docs/reports/migration-readiness-report.md`, `docs/reports/shadow-compare-report.json`, `docs/reports/shadow-matrix-report.json`, `docs/reports/live-shadow-mirror-scorecard.json`, `docs/reports/live-shadow-summary.json`, and `docs/reports/live-shadow-index.json`
