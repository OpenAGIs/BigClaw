...
- `OPE-185` / `BIG-GO-010`
  ...
  - `BIG-GO-901` adds the 100% non-Go executable asset inventory, priority ledger, target package mapping, and first-wave branch/PR sequencing used to close the remaining Python and shell migration gap honestly
- `OPE-186` / `BIG-GO-011`
