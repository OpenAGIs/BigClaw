# BIG-GO-127 Python Asset Sweep

## Scope

Broad repo Python reduction sweep O for `BIG-GO-127` records the remaining
Python asset baseline with explicit focus on `src/bigclaw`, `tests`, `scripts`,
