...
- `cd bigclaw-go && go test ./internal/regression -run TestLiveShadowScorecardBundleStaysAligned -count=1`
- `cd bigclaw-go && go test ./internal/regression -run TestLiveShadowBundleSummaryAndIndexStayAligned -count=1`
