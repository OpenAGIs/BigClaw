...
- Shadow comparison for one task via `docs/reports/shadow-compare-report.json`
- Shadow comparison matrix across multiple task fixtures via `docs/reports/shadow-matrix-report.json`
