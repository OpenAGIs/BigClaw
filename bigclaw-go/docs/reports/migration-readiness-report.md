...
- Repo-native live shadow mirror scorecard via `go run ./cmd/bigclawctl live-shadow scorecard --pretty`
- Repo-native live shadow bundle/index via `go run ./cmd/bigclawctl live-shadow bundle`
...
- `go run ./cmd/bigclawctl live-shadow scorecard --pretty`
- `go run ./cmd/bigclawctl live-shadow bundle`
