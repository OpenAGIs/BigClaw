# BIG-GO-129 Python Asset Sweep

## Scope

`BIG-GO-129` records the residual auxiliary Python sweep state for hidden,
nested, and lower-priority leftovers while keeping the repository's
Go-only replacement surface under regression coverage.
...
The retained non-Python replacement surface for the swept areas includes:
