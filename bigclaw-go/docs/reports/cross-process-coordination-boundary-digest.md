...
- Keep this digest aligned with `docs/reports/event-bus-reliability-report.md`, `docs/reports/multi-node-coordination-report.md`, `docs/reports/cross-process-coordination-capability-surface.json`, and `scripts/e2e/cross_process_coordination_surface/main.go`.
