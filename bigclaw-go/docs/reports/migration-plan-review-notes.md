...
- Shadow compare and matrix outputs now share one bundle contract, so rollback reviews can reference canonical report and summary paths without rebuilding the artifact set by hand.
