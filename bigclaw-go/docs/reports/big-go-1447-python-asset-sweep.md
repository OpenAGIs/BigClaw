# BIG-GO-1447 Python Asset Sweep

## Scope

Heartbeat refill lane `BIG-GO-1447` records the remaining Python asset
...
- `cd bigclaw-go && go test -count=1 ./internal/regression -run 'TestBIGGO1447(RepositoryHasNoPythonFiles|PriorityResidualDirectoriesStayPythonFree|GoReplacementPathsRemainAvailable|LaneReportCapturesSweepState)$'`
  Result: `ok  	bigclaw-go/internal/regression	0.784s`
