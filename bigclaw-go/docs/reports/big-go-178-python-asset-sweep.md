# BIG-GO-178 Python Asset Sweep

## Scope

`BIG-GO-178` (`Broad repo Python reduction sweep Z`) records the remaining
...
- `cd bigclaw-go && go test -count=1 ./internal/regression -run 'TestBIGGO178(RepositoryHasNoPythonFiles|PriorityResidualDirectoriesStayPythonFree|GoReplacementPathsRemainAvailable|LaneReportCapturesSweepState)$'`
