# BIG-GO-1434 Python Asset Sweep

## Scope

Heartbeat refill lane `BIG-GO-1434` records the remaining Python asset
...
- `cd bigclaw-go && go test -count=1 ./internal/regression -run 'TestBIGGO1434(RepositoryHasNoPythonFiles|PriorityResidualDirectoriesStayPythonFree|GoReplacementPathsRemainAvailable|LaneReportCapturesSweepState)$'`
  Result: `ok  	bigclaw-go/internal/regression	0.322s`
