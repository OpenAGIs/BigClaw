...
- The repo now also ships a live two-node companion proof in `docs/reports/live-multi-node-subscriber-takeover-report.json`, generated by `scripts/e2e/multi_node_shared_queue`.
