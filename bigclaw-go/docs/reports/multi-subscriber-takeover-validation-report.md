...
- The repo now also ships a live two-node companion proof in `docs/reports/live-multi-node-subscriber-takeover-report.json`, generated by `go run ./cmd/bigclawctl e2e multi-node-shared-queue`.
