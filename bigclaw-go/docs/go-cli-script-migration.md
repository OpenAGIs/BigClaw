...
| `go run ./cmd/bigclawctl automation e2e run-all ...` | `bigclawctl automation e2e run-all` | Run local/Kubernetes/Ray live validation and refresh bundle artifacts |
| `go run ./cmd/bigclawctl automation e2e broker-bootstrap-summary ...` | `bigclawctl automation e2e broker-bootstrap-summary` | Regenerate the broker bootstrap review summary used by bundle export |
| `./scripts/e2e/run_all.sh` | wraps `automation e2e run-all` | Convenience wrapper for the Go-native live-validation orchestration path |
...
go run ./cmd/bigclawctl automation e2e broker-bootstrap-summary --help
