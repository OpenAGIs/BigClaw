...
| `bigclaw-go/scripts/benchmark/soak_local.py` | `go run ./cmd/bigclawctl automation benchmark soak-local ...` | migrated and compatibility shim removed |
| `bigclaw-go/scripts/benchmark/run_matrix.py` | `go run ./cmd/bigclawctl automation benchmark run-matrix ...` | migrated and Python entrypoint removed |
| `bigclaw-go/scripts/benchmark/capacity_certification.py` | `go run ./cmd/bigclawctl automation benchmark capacity-certification ...` | migrated and Python entrypoint removed |
...
- Report serialization compatibility for JSON consumers that previously read the Python benchmark script output
- Direct Go ownership for benchmark matrix and certification generation
