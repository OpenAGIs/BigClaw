...
def test_checked_in_live_shadow_bundle_matches_expected_shape() -> None:
    manifest = __import__("json").loads(Path('bigclaw-go/docs/reports/live-shadow-index.json').read_text(encoding='utf-8'))
...
# Folded from test_design_system.py for repo-level python file reduction.
...
# Folded from test_ui_review.py for repo-level python file reduction.
...
# Folded from test_operations.py for repo-level python file reduction.
...
# Folded from test_planning.py for repo-level python file reduction.
...
# Folded from conftest.py for repo-level python file reduction.
...
# Folded from test_observability.py for repo-level python file reduction.
