...
- Treat `bigclaw-go` as the sole implementation mainline for new development; this repo currently carries no live `src/bigclaw` tree, so any future Python artifact must be migration-only and explicitly justified.
