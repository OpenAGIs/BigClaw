...
- Treat `bigclaw-go` as the sole implementation mainline for new development; the physical `src/bigclaw` package tree is retired, so repo-level Python follow-ups should prefer deletion, documentation cleanup, or Go-owned compatibility replacements.
